...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UIView *headerView = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, 768, 44)] autorelease];
    headerView.backgroundColor = [UIColor whiteColor];
    
    UIView *borderView = [[[UIView alloc] initWithFrame:CGRectMake(0, 43.5, 768, 0.5)] autorelease];
    ...
    if (appDelegate.comparison) {
        label1 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 80, 44)];
        label1.textColor = [UIColor blackColor];
        label1.textAlignment = UITextAlignmentCenter;
        label1.backgroundColor = [UIColor clearColor];
        label1.text = @"#";
        
        label2 = [[UILabel alloc] initWithFrame:CGRectMake(80, 0, 236, 44)];
        label2.textColor = [UIColor blackColor];
        label2.textAlignment = UITextAlignmentCenter;
        label2.backgroundColor = [UIColor clearColor];
        label2.text = @"Dato";
        
        label3 = [[UILabel alloc] initWithFrame:CGRectMake(316, 0, 100, 44)];
        label3.textColor = [UIColor blackColor];
        label3.textAlignment = UITextAlignmentCenter;
        label3.backgroundColor = [UIColor clearColor];
        label3.text = @"KWh"; 
        
        UILabel * label4 = [[UILabel alloc] initWithFrame:CGRectMake(416, 0, 236, 44)];
        label4.textColor = [UIColor blackColor];
        label4.textAlignment = UITextAlignmentCenter;
        label4.backgroundColor = [UIColor clearColor];
        label4.text = @"Samanber Dato";
        
        UILabel * label5 = [[UILabel alloc] initWithFrame:CGRectMake(652, 0, 100, 44)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (appDelegate.comparison) {
        ...
        UILabel *red = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 80, 44)];
        [cell.contentView addSubview:red];
        red.text = [@"" stringByAppendingFormat:@"%i",indexPath.row];
        red.textAlignment = UITextAlignmentCenter;
        
        UILabel *blue = [[UILabel alloc] initWithFrame:CGRectMake(80, 0, 236, 44)];
        ...
        UILabel *green = [[UILabel alloc] initWithFrame:CGRectMake(316, 0, 100, 44)];
        ...
        UILabel *blue1 = [[UILabel alloc] initWithFrame:CGRectMake(416, 0, 236, 44)];
        ...
        UILabel *green1 = [[UILabel alloc] initWithFrame:CGRectMake(652, 0, 100, 44)];
        ...
        red.font = [UIFont systemFontOfSize:18];
        blue.font = [UIFont systemFontOfSize:18];
        green.font = [UIFont systemFontOfSize:18];
        blue1.font = [UIFont systemFontOfSize:18];
        green1.font = [UIFont systemFontOfSize:18];
        ...
        UILabel *blue = [[UILabel alloc] initWithFrame:CGRectMake(373, 0, 107, 44)];
        [cell.contentView addSubview:blue];
        blue.text = [valuesForDates objectAtIndex:indexPath.row];
        blue.textAlignment = UITextAlignmentCenter;
        
        cell.userInteractionEnabled = FALSE;
        
        cell.text = [dates objectAtIndex:indexPath.row];*/
    }
    return cell;
